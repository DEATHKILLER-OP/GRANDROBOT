...
TECHNO_IMG = "https://telegra.ph/file/bf3f0d081b059e4caae2f.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/ROCKY_8218")],
                                                                                   [InlineKeyboardButton(text="ADD ᎧᎮᴸᵉᵍᵉⁿᵈ TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="t.me/O_O_LEGEND_O_O")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Yuss,I ONLINE I CAN HELP U 😁")
